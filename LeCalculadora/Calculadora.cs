...
namespace Calculadora
{
    public partial class Calculadora : UserControl
    {
        ...
        OperacionesBasicas ElCalculatorMC = new OperacionesBasicas();
                ...
                if (arreglo.Count > 1)
                {
                    ...
                    if (arreglo.Contains('x') || arreglo.Contains('/'))
                    {
                        ...
                        if (arreglo.IndexOf('x') != -1 && (arreglo.IndexOf('x') < arreglo.IndexOf('/') || arreglo.IndexOf('/') == -1))
                        {
                            ...
                            arreglo[(arreglo.IndexOf('x') - cuno)] = ElCalculatorMC.Mult(Convert.ToInt32(opuno),Convert.ToInt32(opdos));//Convert.ToString(Convert.ToInt32(opuno) * Convert.ToInt32(opdos));
